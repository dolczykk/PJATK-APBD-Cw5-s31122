    ...
    IAssignBedService assignBedService) : ControllerBase
{
    ...
    public async Task<ActionResult<BaseResponse>> GetPatients([FromQuery] string? search,
    ...
    public async Task<ActionResult<BaseResponse>> AssignBed(string pesel, [FromBody] AssignBedRequest request,
        CancellationToken cancellationToken)
    {
